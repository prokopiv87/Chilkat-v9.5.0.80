...
#ifndef _CKHTTPPROGRESSU_H
#define _CKHTTPPROGRESSU_H
...
// When creating an application class that inherits the CkHttpProgressU base class, use the CK_HTTPPROGRESSU_API 
...
// For example:
/*
    class MyProgress : public CkHttpProgressU
    {
	public:
	    CK_HTTPPROGRESSU_API

	...
    };
*/
#define CK_HTTPPROGRESSU_API \
	void HttpRedirect(const uint16_t *originalUrl, const uint16_t *redirectUrl, bool *abort);\
...
class CkHttpProgressU : public CkBaseProgressU
{
    public:
	CkHttpProgressU() { }
	virtual ~CkHttpProgressU() { }

	virtual void HttpRedirect(const uint16_t *originalUrl, const uint16_t *redirectUrl, bool *abort) { }
